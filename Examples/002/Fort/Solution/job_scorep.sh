...
# Tell Score-P to pause the program every 10 million CPU cycles and look at the call stack to see libc functions!
...
export PROGRAM="${BUILD_DIR}/mandelbrot_mpi"
...
# Basic Summary: Shows time spent in MPI vs User code vs OpenMP
echo "Generating general summary..."
scorep-score ${CUBEX_FILE} > ${SCOREP_EXPERIMENT_DIRECTORY}/scorep_summary.txt
